  ...
  const pillars: PillarResult[] = [
    {
      ...
      rows: [
        ...
        { label: `Gross profit (${pct(blendedProfit / blendedTicket)} blended margin)`, math: "", value: money(p1Profit), dim: true },
      ],
      footer: `Today you answer ${monthlyAnswered} of every ${inputs.monthlyLeads} calls. Your AI teammate answers the ${monthlyMissed} that you miss. At your ${pct(inputs.bookingRate)} close rate, that's ${count(p1NewCustomers)} new customers booked by year-end.`,
    },
    {
      id: "p2",
      eyebrow: "Pillar 02",
      ...
      rows: [
        ...
        { label: `× ${pct(m.noShowRate)} no-show or cancel today (industry estimate)`, math: "", value: `${count(p2NoShows)} no-shows/yr` },
        ...
        { label: `Gross profit (${pct(blendedProfit / blendedTicket)} blended margin)`, math: "", value: money(p2Profit), dim: true },
      ],
  ...
  if (hasPlanPillar) {
    ...
    pillars.push({
      ...
      rows: [
        ...
        { label: `× ${pct(m.attachRate)} sign up for the plan`, math: "", value: `${count(p3Attached)} plan members` },
        { label: `× ${money(inputs.planFeeAnnual)} annual plan fee`, math: "", value: money(p3Revenue), strong: true },
        { label: `Gross profit (${pct(t.smallMargin)} margin after the tune-up tech)`, math: "", value: money(p3Profit), dim: true },
